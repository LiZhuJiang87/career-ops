...
## [0.12.0](https://github.com/LiZhuJiang87/career-ops/compare/web-v0.11.0...web-v0.12.0) (2026-09-23)
...
* **web:** resizable assistant panel and a composer that grows with its content ([#4258](https://github.com/LiZhuJiang87/career-ops/issues/4258)) ([8be08ce](https://github.com/LiZhuJiang87/career-ops/commit/8be08ce362d45556b12bb659fd66360cd409ebb3))


### Bug Fixes

* run the web test suite on the minimum supported Node ([#4065](https://github.com/LiZhuJiang87/career-ops/issues/4065)) ([533a4a8](https://github.com/LiZhuJiang87/career-ops/commit/533a4a8dc0802fffc5a87afb3d380776bde6da14))
...
* **url-key:** preserve existing fragment comparison params ([02e632e](https://github.com/LiZhuJiang87/career-ops/commit/02e632e634280ef7224ec268279adbbe9f0650ce))
* **url-key:** preserve hash-route posting identity ([52f314c](https://github.com/LiZhuJiang87/career-ops/commit/52f314cd268bd0b2de56b71ba236ce288138dac0))
* **url-key:** preserve hash-route posting identity ([965fff3](https://github.com/LiZhuJiang87/career-ops/commit/965fff30149eff1da2f6b1a937ca3738260b9a2e))
* **web:** add vertical padding to pipeline facet chips ([#4038](https://github.com/LiZhuJiang87/career-ops/issues/4038)) ([b6bc5ff](https://github.com/LiZhuJiang87/career-ops/commit/b6bc5ffb92e847e43b91042d4b828c99ce5960a2))
* **web:** add vertical padding to pipeline facet chips ([#4038](https://github.com/LiZhuJiang87/career-ops/issues/4038)) ([33a56a2](https://github.com/LiZhuJiang87/career-ops/commit/33a56a2e68c03bc67f13e1b99ac3decd26be8e8e))
...
* **web:** let report tables use the screen on large displays ([e571f2c](https://github.com/LiZhuJiang87/career-ops/commit/e571f2cb9de3f8952863e5c51adc437a09b83fef))
* **web:** let report tables use the screen on large displays ([b80aee1](https://github.com/LiZhuJiang87/career-ops/commit/b80aee1bc530f6ac8c6a6aec882af5c4a5431822))
* **web:** make CLI choices fully clickable ([b4be24f](https://github.com/LiZhuJiang87/career-ops/commit/b4be24f2b9e476888dedb5ee85d29df68baf53df))
* **web:** make CLI choices fully clickable ([977bb11](https://github.com/LiZhuJiang87/career-ops/commit/977bb1144fec223f98b66984a9dfeb508d73f08f))
...
* **web:** persist the default CLI at any installed count, not only a sole one ([#4151](https://github.com/LiZhuJiang87/career-ops/issues/4151)) ([ecbe651](https://github.com/LiZhuJiang87/career-ops/commit/ecbe651320d5da9a97ea29a0ee7e39cbd14207ed))
* **web:** pluralize the Analytics evaluation count ([#3161](https://github.com/LiZhuJiang87/career-ops/issues/3161)) ([7c91c6d](https://github.com/LiZhuJiang87/career-ops/commit/7c91c6d9682c0441b8fdd1c0a6ce983524be02fd))
* **web:** resolve the data root exactly as the core does ([#4064](https://github.com/LiZhuJiang87/career-ops/issues/4064)) ([1704575](https://github.com/LiZhuJiang87/career-ops/commit/17045758851f7c7294e23669f4e6c8d34edf1712))
